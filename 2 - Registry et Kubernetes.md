...
Pour pouvoir envoyer des images sur le docker hub, il faut au préalable les **tagger** en suivant cette nomenclature **VOTRE-USERNAME/NOM-DE-L-IMAGE**, ce qui dans mon caspour lab-survey-front donne `docker tag lab-survey-front riges/lab-survey-front`.
